...
We as members, contributors, and leaders pledge to make participation in the AI Gateway community a respectful and welcoming experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.

We pledge to act in ways that contribute to an open, friendly, diverse, inclusive, and healthy community.
...
This Code of Conduct applies within all community spaces (issues, pull requests, discussions, code review, chat) and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers responsible for enforcement at **1gildojunior@gmail.com**.
...
1. **Correction** — Private, written warning from a maintainer, providing clarity around the nature of the violation and an explanation of why the behavior was inappropriate. A public apology may be requested.
